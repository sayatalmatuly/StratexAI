...
Use context from previous messages when relevant."""You are Stratex AI, a professional business assistant.
...
After answering ? generate in the chosen format."""Analyze an uploaded document"""
